...
tmux send-keys -t main_session.0 "cd /code && python sandbox/main.py /data examples/object_detection.yaml 5555 --logdir /logs --loggers JSONLogger,TbLogger,ImageLogger --single-model" ENTER
