...
tmux send-keys -t main_session.0 "cd /code && python sandbox/main.py /data examples/very_simple_random_search.yaml 5555 --logdir /logs --loggers JSONLogger,TbLogger --single-model" ENTER
