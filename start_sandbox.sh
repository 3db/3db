...
tmux send-keys -t main_session.0 "cd /code && python sandbox/main.py /data examples/mitsuba_example.yaml 5555 --logdir /logs --loggers JSONLogger,TbLogger --single-model" ENTER
